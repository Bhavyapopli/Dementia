...
# def load_resources():
#     glove_model = KeyedVectors.load_word2vec_format("models/glove.6B.100d.word2vec.txt", binary=False)
...
# else:
#     st.info("Upload a .cha file and a trained model (.pkl) to run inference.")
